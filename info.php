...
<head>
    ...
    <title>Informazioni PHP - EDOARDO ZAFFARONI</title>
    <style>
        body {
...
<body>
    <div class='header'>
        ...
        <p>Configurazione del server PHP per EDOARDO ZAFFARONI</p>
    </div>
    
    <div class='info-box'>
        <h2>📊 Dati Studente</h2>
        <p><strong>Nome:</strong> EDOARDO ZAFFARONI</p>
        <p><strong>Classe:</strong> 4CINF</p>
        <p><strong>Username:</strong> zaffaroni.edoardo</p>
